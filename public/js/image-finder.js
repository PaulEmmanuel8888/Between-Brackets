document.addEventListener("DOMContentLoaded", () => {
  ...
  async function searchImages() {
    ...
    //   imageLink.setAttribute("loading", "lazy");
    ...
    //   downloadBtn.innerHTML = `<img src="/images/copy.svg"/>`;

    //   pictureDiv.appendChild(imageLink);
    //   pictureDiv.appendChild(downloadBtn);
    //   searchResult.appendChild(pictureDiv);
    // });
